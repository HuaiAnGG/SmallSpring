...
import wiki.laona.springframework.context.support.ClassPathXmlApplicationContext;
...
import wiki.laona.springframework.test.common.MyBeanFactoryPostProcessor;
import wiki.laona.springframework.test.common.MyBeanPostProcessor;
...
public class ApiTest {
    ...
    @Test
    public void test_BeanFactoryPostProcessorAndBeanPostProcessor_without_context(){
        // 1.初始化 BeanFactory
        DefaultListableBeanFactory beanFactory = new DefaultListableBeanFactory();
